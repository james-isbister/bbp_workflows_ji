...
def gen_whisker_flick_stim_and_find_fibers_all(*, path, **kwargs):
    ...
    for fib_grp_i, fib_grp in enumerate(fib_grps):
        ...
        if (cfg[pct_key] > 0.0):
            ...
            spike_times, spiking_gid_indices = spikewriter.generate_ji_psth_defined_spike_trains(stim_times, selected_gid_indices, cfg["psth_x"], cfg["psth_y"], cfg["stim_seed"] + fib_grp_i)
