...
def get_projection_locations(c, projection_name, mask=None, mask_type="bbox", supersample=False):
    ...
    if projection_name in c.nodes.population_names:
        ...
        """If circuit is subset of full sscx virtual vpm fibers
        in nodes['VPM'] are only a subset of full sscx fibers
        This code block finds the corresponding vpm fibers in 
        the full sscx for the flatmapping operation"""
